        ...
        Column(
            ...
            Box(
                ...
                ProvideTextStyle(textStyle) {
                    if (animatedStateValue - 1 != range!!.first-1){
                        Label(
                            text = (animatedStateValue - 1).toString(),
                            modifier = baseLabelModifier
                                .offset(y = -halvedNumbersColumnHeight)
                                .alpha(maxOf(minimumAlpha, coercedAnimatedOffset / halvedNumbersColumnHeightPx))
                    ...
                    Label(
                        ...
                        modifier = baseLabelModifier
                            .alpha(
                                (maxOf(
                                    minimumAlpha,
                                    1 - abs(coercedAnimatedOffset) / halvedNumbersColumnHeightPx
                                ))
                            )

                        //  .alpha(1 - abs(coercedAnimatedOffset) / halvedNumbersColumnHeightPx)
                    )
                    if (animatedStateValue + 1 != range.last+1) {
                        Label(
                            text = (animatedStateValue + 1).toString(),
                            modifier = baseLabelModifier
                                .offset(y = halvedNumbersColumnHeight)
                                .alpha(
                                    maxOf(
                                        minimumAlpha,
                                        -coercedAnimatedOffset / halvedNumbersColumnHeightPx
                                    )
                                )
                            //  .alpha(-coercedAnimatedOffset / halvedNumbersColumnHeightPx)
                        )
